...
```k
  ...
  syntax Instruction ::= "CAST" AnnotationList                          [unused]
  syntax Instruction ::= "RENAME" AnnotationList                        [unused]
  ...
  syntax Instruction ::= "CREATE_ACCOUNT" AnnotationList                [unused]
  ...
  syntax Instruction ::= "STEPS_TO_QUOTA" AnnotationList                [unused]
...
```k
  ...
  syntax Macro ::= DIPMacro AnnotationList Block                    [unused]
  syntax Macro ::= DUPMacro AnnotationList                          [unused]
  syntax Macro ::= PairMacro AnnotationList                         [unused]
  syntax Macro ::= UnpairMacro AnnotationList                       [unused]
  syntax Macro ::= CDARMacro AnnotationList                         [unused]
  syntax Macro ::= SetCDARMacro AnnotationList                      [unused]

  syntax Macro ::= "CMPEQ" AnnotationList                           [unused]
  syntax Macro ::= "CMPNEQ" AnnotationList                          [unused]
  syntax Macro ::= "CMPLT" AnnotationList                           [unused]
  syntax Macro ::= "CMPGT" AnnotationList                           [unused]
  syntax Macro ::= "CMPLE" AnnotationList                           [unused]
  syntax Macro ::= "CMPGE" AnnotationList                           [unused]
  syntax Macro ::= "IFEQ" AnnotationList Block Block                [unused]
  syntax Macro ::= "IFNEQ" AnnotationList Block Block               [unused]
  syntax Macro ::= "IFLT" AnnotationList Block Block                [unused]
  syntax Macro ::= "IFGT" AnnotationList Block Block                [unused]
  syntax Macro ::= "IFLE" AnnotationList Block Block                [unused]
  syntax Macro ::= "IFGE" AnnotationList Block Block                [unused]
  syntax Macro ::= "IFCMPEQ" AnnotationList Block Block             [unused]
  syntax Macro ::= "IFCMPNEQ" AnnotationList Block Block            [unused]
  syntax Macro ::= "IFCMPLT" AnnotationList Block Block             [unused]
  syntax Macro ::= "IFCMPGT" AnnotationList Block Block             [unused]
  syntax Macro ::= "IFCMPLE" AnnotationList Block Block             [unused]
  syntax Macro ::= "IFCMPGE" AnnotationList Block Block             [unused]
  syntax Macro ::= "FAIL" AnnotationList                            [unused]
  syntax Macro ::= "ASSERT" AnnotationList                          [unused]
  syntax Macro ::= "ASSERT_EQ" AnnotationList                       [unused]
  syntax Macro ::= "ASSERT_NEQ" AnnotationList                      [unused]
  syntax Macro ::= "ASSERT_LT" AnnotationList                       [unused]
  syntax Macro ::= "ASSERT_LE" AnnotationList                       [unused]
  syntax Macro ::= "ASSERT_GT" AnnotationList                       [unused]
  syntax Macro ::= "ASSERT_GE" AnnotationList                       [unused]
  syntax Macro ::= "ASSERT_CMPEQ" AnnotationList                    [unused]
  syntax Macro ::= "ASSERT_CMPNEQ" AnnotationList                   [unused]
  syntax Macro ::= "ASSERT_CMPLT" AnnotationList                    [unused]
  syntax Macro ::= "ASSERT_CMPLE" AnnotationList                    [unused]
  syntax Macro ::= "ASSERT_CMPGT" AnnotationList                    [unused]
  syntax Macro ::= "ASSERT_CMPGE" AnnotationList                    [unused]
  syntax Macro ::= "ASSERT_NONE" AnnotationList                     [unused]
  syntax Macro ::= "ASSERT_SOME" AnnotationList                     [unused]
  syntax Macro ::= "ASSERT_LEFT" AnnotationList                     [unused]
  syntax Macro ::= "ASSERT_RIGHT" AnnotationList                    [unused]
  syntax Macro ::= "IF_SOME" AnnotationList Block Block             [unused]
  syntax Macro ::= "IF_RIGHT" AnnotationList Block Block
  syntax Macro ::= "SET_CAR" AnnotationList                         [unused]
  syntax Macro ::= "SET_CDR" AnnotationList                         [unused]
```
...
```k
  ...
  syntax ParameterValueGroup ::= "parameter_value" Data             [unused]
  syntax StorageValueGroup ::= "storage_value" Data                 [unused]
